...
# File Created at 2023-04-17 16:30:26.364650
...
def ode_solv(y, integ_step, rrc, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((27562+jac_mod_len))
		...
		part_eff = np.zeros((11081))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:4749:3] = -kimt[0:num_asb, :].sum(axis=0) # effect of gas on gas
