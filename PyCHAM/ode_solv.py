...
# File Created at 2022-06-08 17:28:49.444051
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		if (Cw > 0.):
			wall_eff = np.zeros((13072))
			wall_eff[0:6536:2] = -kw # effect of gas on gas 
			wall_eff[1:6536:2] = +kw # effect of gas on wall 
			# effect of wall on gas
			wall_eff[6536:13072:2] = +kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
			# effect of wall on wall
			wall_eff[6536+1:13072:2] = -kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
