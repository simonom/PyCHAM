...
# File Created at 2021-07-15 10:11:50.955688
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def dydt(t, y): # define the ODE(s)
		...
		dd[[20, 11, 2, 3, 7, 313], 0] += Cinfl_now[:, 0]
	...
	def jac(t, y): # define the Jacobian
		...
		if (Cw > 0.):
			wall_eff = np.zeros((1260))
			wall_eff[0:630:2] = -kw # effect of gas on gas 
			wall_eff[1:630:2] = +kw # effect of gas on wall 
			# effect of wall on gas
			wall_eff[630:1260:2] = +kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
			# effect of wall on wall
			wall_eff[630+1:1260:2] = -kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
