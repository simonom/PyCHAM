...
# File Created at 2024-07-22 16:37:24.189903
...
def ode_solv(y, integ_step, rrc, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((62411+jac_mod_len))
		...
		part_eff = np.zeros((48657))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:16881:17] = -kimt[0:num_asb, :].sum(axis=0) # effect of gas on gas
