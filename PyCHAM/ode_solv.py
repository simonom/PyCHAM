...
# File Created at 2022-03-24 16:45:45.069552
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		if (Cw > 0.):
			wall_eff = np.zeros((124))
			wall_eff[0:62:2] = -kw # effect of gas on gas 
			wall_eff[1:62:2] = +kw # effect of gas on wall 
			# effect of wall on gas
			wall_eff[62:124:2] = +kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
			# effect of wall on wall
			wall_eff[62+1:124:2] = -kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
