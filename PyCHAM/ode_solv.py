...
# File Created at 2021-09-27 16:33:59.062029
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def dydt(t, y): # define the ODE(s)
		...
		dd[RO2_indx] -= y[RO2_indx]*(lr) # RO2 components following Silvia thesis
		dd[(num_comp*num_sb)+RO2_indx] += y[RO2_indx]*(lr) # RO2 components following Silvia thesis
		...
		dd[[1, 38, 969, 10, 21, 2, 3], 0] += Cinfl_now[:, 0]
		# account for continuous extraction of chamber air
		if (wall_on == 1): # if wall on
			dd[0:-num_comp, 0] -= y[0:-num_comp, 0]*1.*dil_fac
		if (wall_on == 0): # if wall off
			dd[0::, 0] -= y[0::, 0]*1.*dil_fac
