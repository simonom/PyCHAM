...
# File Created at 2021-05-14 10:34:13.302794
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((57345+jac_mod_len))
		...
		# gas-particle partitioning
		part_eff = np.zeros((47579))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:16507:17] = -kimt.sum(axis=0) # effect of gas on gas
