...
# File Created at 2022-10-19 13:35:28.762398
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((109712+jac_mod_len))
		...
		part_eff = np.zeros((74602))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:27128:8] = -kimt[0:num_asb, :].sum(axis=0) # effect of gas on gas
