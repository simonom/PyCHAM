...
# File Created at 2022-02-24 15:53:39.943313
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((45489+jac_mod_len))
		...
		# gas-particle partitioning
		part_eff = np.zeros((30976))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:11616:6] = -kimt.sum(axis=0) # effect of gas on gas
