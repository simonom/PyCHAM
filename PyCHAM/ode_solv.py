...
# File Created at 2022-09-02 16:51:15.562871
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def dydt(t, y): # define the ODE(s)
		...
		dd[[10, 21, 23, 25, 28, 31, 35, 39, 41, 43, 45, 47, 49, 51, 53, 55, 57, 59, 60, 63, 66, 68, 72, 73, 211, 76, 80, 84, 89, 94, 99, 104, 83, 113, 118, 123, 128, 131, 138, 142, 143, 150, 218, 150, 164, 172, 179, 183, 186, 190, 193, 196, 198, 203, 206, 209, 211, 212, 216, 2635], 0] += Cinfl_now[:, 0]
