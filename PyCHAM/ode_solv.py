...
# File Created at 2026-01-16 11:34:04.334943
...
def ode_solv(y, integ_step, rrc, 
	...
	# self.Psat - pure component saturation vapour pressures (# molecules/cm^3)
	# self.Cw - effective absorbing mass concentration of wall (# molecules/cm^3) 
	...
	# N_perbin - number concentration of particles per size bin (# particles/cm^3)
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((112214+jac_mod_len))
		...
		# gas-particle partitioning
		part_eff = np.zeros((104372))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:35508:33] = -kimt[0:num_asb, :].sum(axis=0) # effect of gas on gas
