...
# File Created at 2023-09-14 06:42:56.035691
...
def ode_solv(y, integ_step, rrc, 
	...
	sol = solve_ivp(dydt, [0, integ_step], y, atol = atol, rtol = rtol, method = 'LSODA', t_eval = [integ_step], vectorized = True, jac = jac)
