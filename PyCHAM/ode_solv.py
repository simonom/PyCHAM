...
# File Created at 2022-07-25 14:54:26.068319
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def dydt(t, y): # define the ODE(s)
		...
		dd[[49, 1, 10, 28, 2, 3, 20], 0] += Cinfl_now[:, 0]
	...
	def jac(t, y): # define the Jacobian
		...
		if (Cw > 0.):
			wall_eff = np.zeros((2900))
			wall_eff[0:1450:2] = -kw # effect of gas on gas 
			wall_eff[1:1450:2] = +kw # effect of gas on wall 
			# effect of wall on gas
			wall_eff[1450:2900:2] = +kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
			# effect of wall on wall
			wall_eff[1450+1:2900:2] = -kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
