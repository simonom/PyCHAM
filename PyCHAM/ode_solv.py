...
# File Created at 2025-04-05 07:46:34.150764
...
def ode_solv(y, integ_step, rrc, 
	...
	def dydt(t, y): # define the ODE(s)
		...
		if (y[self.comp_namelist.index('OH')][0]>0.):
			self.kOH = gpr_lr[self.comp_namelist.index('OH')]/y[self.comp_namelist.index('OH')][0]
		# gain of products
