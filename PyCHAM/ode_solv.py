...
# File Created at 2022-08-22 15:41:26.585490
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((18117+jac_mod_len))
		...
		wall_eff = np.zeros((6153))
		# effect of gas on gas 
		wall_eff[0:2637:3] = -np.sum(kimt[num_asb::, :], axis=0) 
		for wsb in range(int(self.wall_on)): # wall bin loop
			if (self.Cw[wsb, 0] > 0.):
				# effect of gas on wall 
				wall_eff[wsb+1:2637:3] = +kimt[num_asb+wsb, :] 
