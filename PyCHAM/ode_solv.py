...
# File Created at 2023-05-18 15:50:44.240547
...
def ode_solv(y, integ_step, rrc, 
	...
	def jac(t, y): # define the Jacobian
		...
		wall_eff = np.zeros((24))
		# effect of gas on gas 
		wall_eff[0:12:2] = -np.sum(kimt[num_asb::, :], axis=0) 
		for wsb in range(int(self.wall_on)): # wall bin loop
			if (self.Cw[wsb, 0] > 0.):
				# effect of gas on wall 
				wall_eff[wsb+1:12:2] = +kimt[num_asb+wsb, :] 
