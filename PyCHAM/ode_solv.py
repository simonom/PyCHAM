...
# File Created at 2024-02-07 07:59:01.319719
...
def ode_solv(y, integ_step, rrc, 
	...
	def jac(t, y): # define the Jacobian
		...
		# gas-particle partitioning
		part_eff = np.zeros((161))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:69:3] = -kimt[0:num_asb, :].sum(axis=0) # effect of gas on gas
