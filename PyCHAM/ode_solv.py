...
# File Created at 2021-05-06 14:40:48.675219
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		if (Cw > 0.):
			wall_eff = np.zeros((508))
			wall_eff[0:254:2] = -kw # effect of gas on gas 
			wall_eff[1:254:2] = +kw # effect of gas on wall 
			# effect of wall on gas
			wall_eff[254:508:2] = +kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
			# effect of wall on wall
			wall_eff[254+1:508:2] = -kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
