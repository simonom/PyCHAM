...
# File Created at 2024-12-09 10:43:56.318813
...
def ode_solv(y, integ_step, rrc, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((11798+jac_mod_len))
		...
		part_eff = np.zeros((2428))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:1214:2] = -kimt[0:num_asb, :].sum(axis=0) # effect of gas on gas
