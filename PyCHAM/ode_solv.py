...
# File Created at 2020-11-02 16:33:42.673419
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t,y): # define the Jacobian
		...
		# gas-particle partitioning
		part_eff = np.zeros((168))
		part_eff[0:72:3] = -kimt.sum(axis=0) # effect of gas on gas
		...
		if (Cw>0.):
			wall_eff = np.zeros((96))
			wall_eff[0:48:2] = -kw # effect of gas on gas 
			wall_eff[1:48:2] = +kw # effect of gas on wall 
			# effect of wall on gas
			wall_eff[48:96:2] = +kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
			# effect of wall on wall
			wall_eff[48+1:96:2] = -kw*(Psat[0,:]*act_coeff[0, :]/Cw) 
