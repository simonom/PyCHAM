...
# File Created at 2025-06-25 15:48:10.138045
...
def ode_solv(y, integ_step, rrc, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((146590+jac_mod_len))
		...
		part_eff = np.zeros((61761))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:26469:3] = -kimt[0:num_asb, :].sum(axis=0) # effect of gas on gas
