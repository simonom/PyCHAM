...
# File Created at 2022-03-30 10:52:22.789532
...
def ode_solv(y, integ_step, rindx, pindx, rstoi, pstoi, 
	...
	def jac(t, y): # define the Jacobian
		...
		data = np.zeros((18536+jac_mod_len))
		...
		# gas-particle partitioning
		part_eff = np.zeros((15435))
		if (sum(N_perbin[:, 0]) > 0.): # if any particles present 
			part_eff[0:5355:17] = -kimt.sum(axis=0) # effect of gas on gas
