...
print('The script to create plots for assessment of size structures; note needs to be called from the PyCHAM home folder')
...
output_by_sim = str(cwd + '/PyCHAM/output/moving_centre_scheme/test_Zhang_100sb_fm')
...
# open saved files
output_by_sim = str(cwd + '/PyCHAM/output/moving_centre_scheme/test_Zhang_100sb_mc')
...
# open full-moving
cwd = os.getcwd() # get current working directory
output_by_sim = str(cwd + '/PyCHAM/output/moving_centre_scheme/test_Jacobs_16sb_fm')
...
# open moving-centre
cwd = os.getcwd() # get current working directory
output_by_sim = str(cwd + '/PyCHAM/output/moving_centre_scheme/test_Jacobs_16sb_mc')
