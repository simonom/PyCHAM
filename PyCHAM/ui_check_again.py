...
def ui_check(sav_nam, sch_name, wall_on, caller, siz_stru, num_sb, pmode, pconc, pconct, lowsize, std, 
			mean_rad, new_partr, chamSA, 
	...
	return(wall_on, pconc, lowsize, std, mean_rad, new_partr, chamR, chem_sch_mark, 
			af_path, int_tol, update_stp, tot_time, siz_stru, light_stat, light_time, seedVr, 
			seed_diss, uman_up)