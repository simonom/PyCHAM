...
def mcm_constants(TEMP, H2O, M, N2, O2, time, lat, lon, act_flux_path, DayOfYear):
    
	# write a name list of MCM constants; Automatically generated
	# name list for MCM V3.3
	MCMConstNameList = [
...
# 		'KMT17']
	...
	# Rate coefficients from the MCM_KPP (V3.3 of MCM) file
	...
	# Rate coefficients from the MCM_KPP (V3.1 of MCM) file
# 	KRO2NO = 2.54e-12*numpy.exp(360/TEMP) ;
# 	KRO2HO2 = 2.91e-13*numpy.exp(1300/TEMP) ;
# 	KAPHO2 = 4.30e-13*numpy.exp(1040/TEMP) ;
# 	KAPNO = 8.10e-12*numpy.exp(270/TEMP) ;
# 	KRO2NO3 = 2.50e-12 ;
# 	KNO3AL = 1.44e-12*numpy.exp(-1862/TEMP) ;
# 	KDEC = 1.00e+06 ;
# 	KROPRIM = 3.70e-14*numpy.exp(-460/TEMP) ;
# 	KROSEC = 1.80e-14*numpy.exp(-260/TEMP) ;
# 	KD0 = 4.90e-03*M*numpy.exp(-12100/TEMP) ;
# 	KDI = 5.40e+16*numpy.exp(-13830/TEMP) ;
# 	KRD = KD0/KDI ;
# 	FCD = 0.3 ;
# 	NCD = 0.75-1.27*(numpy.log10(FCD)) ;
# 	FD = 10**(numpy.log10(FCD)/(1+(numpy.log10(KRD)/NCD)**2)) ;
...
# 	KCI = 1.20e-11*(TEMP/300)**-0.9 ;
# 	KRC = KC0/KCI ;
# 	FCC = 0.3 ;
# 	NC = 0.75-1.27*(numpy.log10(FCC)) ;
# 	FC = 10**(numpy.log10(FCC)/(1+(numpy.log10(KRC)/NC)**2)) ;
# 	KFPAN = (KC0*KCI)*FC/(KC0+KCI) ;
# 	K10 = 1.00e-31*M*(TEMP/300)**-1.6 ;
# 	K1I = 3.00e-11*(TEMP/300)**0.3 ;
# 	KR1 = K10/K1I ;
# 	FC1 = 0.85 ;
# 	NC1 = 0.75-1.27*(numpy.log10(FC1)) ;
# 	F1 = 10**(numpy.log10(FC1)/(1+(numpy.log10(KR1)/NC1)**2)) ;
# 	KMT01 = (K10*K1I)*F1/(K10+K1I) ;
# 	K20 = 1.30e-31*M*(TEMP/300)**-1.5 ;
# 	K2I = 2.30e-11*(TEMP/200)**0.24 ;
# 	KR2 = K20/K2I ;
# 	FC2 = 0.6 ;
# 	NC2 = 0.75-1.27*(numpy.log10(FC2)) ;
# 	F2 = 10**(numpy.log10(FC2)/(1+(numpy.log10(KR2)/NC2)**2)) ;
# 	KMT02 = (K20*K2I)*F2/(K20+K2I) ;
# 	K30 = 3.60e-30*M*(TEMP/300)**-4.1 ;
# 	K3I = 1.90e-12*(TEMP/300)**0.2 ;
# 	KR3 = K30/K3I ;
# 	FC3 = 0.35 ;
# 	NC3 = 0.75-1.27*(numpy.log10(FC3)) ;
# 	F3 = 10**(numpy.log10(FC3)/(1+(numpy.log10(KR3)/NC3)**2)) ;
# 	KMT03 = (K30*K3I)*F3/(K30+K3I) ;
# 	K40 = 1.00e-03*M*(TEMP/300)**-3.5*numpy.exp(-11000/TEMP) ;
# 	K4I = 9.70e+14*(TEMP/300)**0.1*numpy.exp(-11080/TEMP) ;
# 	KR4 = K40/K4I ;
# 	FC4 = 0.35 ;
# 	NC4 = 0.75-1.27*(numpy.log10(FC4)) ;
# 	F4 = 10**(numpy.log10(FC4)/(1+(numpy.log10(KR4)/NC4)**2)) ;
# 	KMT04 = (K40*K4I)*F4/(K40+K4I) ;
# 	KMT05 = 1 + ((0.6*M)/(2.652e+19*(300/TEMP))) ;
# 	KMT06 = 1 + (1.40e-21*numpy.exp(2200/TEMP)*H2O) ;
# 	K70 = 7.40e-31*M*(TEMP/300)**-2.4 ;
# 	K7I = 3.30e-11*(TEMP/300)**-0.3 ;
# 	KR7 = K70/K7I ;
# 	FC7 = numpy.exp(-TEMP/1420) ;
# 	NC7 = 0.75-1.27*(numpy.log10(FC7)) ;
# 	F7 = 10**(numpy.log10(FC7)/(1+(numpy.log10(KR7)/NC7)**2)) ;
# 	KMT07 = (K70*K7I)*F7/(K70+K7I) ;
# 	K80 = 3.30e-30*M*(TEMP/300)**-3.0 ;
# 	K8I = 4.10e-11 ;
# 	KR8 = K80/K8I ;
# 	FC8 = 0.4 ;
# 	NC8 = 0.75-1.27*(numpy.log10(FC8)) ;
...
# 	KMT09 = (K90*K9I)*F9/(K90+K9I) ;
# 	K100 = 4.10e-05*M*numpy.exp(-10650/TEMP) ;
# 	K10I = 4.80e+15*numpy.exp(-11170/TEMP) ;
# 	KR10 = K100/K10I ;
# 	FC10 = 0.5 ;
# 	NC10 = 0.75-1.27*(numpy.log10(FC10)) ;
# 	F10 = 10**(numpy.log10(FC10)/(1+(numpy.log10(KR10)/NC10)**2)) ;
...
# 	F13 = 10**(numpy.log10(FC13)/(1+(numpy.log10(KR13)/NC13)**2)) ;
# 	KMT13 = (K130*K13I)*F13/(K130+K13I) ;
# 	K140 = 9.00e-05*numpy.exp(-9690/TEMP)*M ;
# 	K14I = 1.10e+16*numpy.exp(-10560/TEMP) ;
# 	KR14 = K140/K14I ;
# 	FC14 = 0.36 ;
# 	NC14 = 0.75-1.27*(numpy.log10(FC14)) ;
# 	F14 = 10**(numpy.log10(FC14)/(1+(numpy.log10(KR14)/NC14)**2)) ;
# 	KMT14 = (K140*K14I)*F14/(K140+K14I) ;
# 	K150 = 7.00e-29*(TEMP/300)**-3.1*M ;
# 	K15I = 9.00e-12 ;
# 	KR15 = K150/K15I ;
# 	FC15 = 0.48 ;
# 	NC15 = 0.75-1.27*(numpy.log10(FC15)) ;
...
# 	K17I = 9.40e-12*numpy.exp(-700/TEMP) ;
# 	KR17 = K170/K17I ;
# 	FC17 = (numpy.exp(-TEMP/580) + numpy.exp(-2320/TEMP)) ;
# 	NC17 = 0.75-1.27*(numpy.log10(FC17)) ;
# 	F17 = 10**(numpy.log10(FC17)/(1.0+(numpy.log10(KR17)/NC17)**2)) ;
# 	KMT17 = (K170*K17I*F17)/(K170+K17I) ;
