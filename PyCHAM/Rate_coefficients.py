...
# File Created as 2019-10-28 16:10:51.043239
...
def evaluate_rates(RO2, H2O, TEMP, lightm):
    ...
    rate_values[937] = 1.2e-11*numpy.exp(440/TEMP)*0.542
    rate_values[938] = 1.2e-11*numpy.exp(440/TEMP)*0.323
    ...
    rate_values[942] = 6.3e-16*numpy.exp(-580/TEMP)*0.04
