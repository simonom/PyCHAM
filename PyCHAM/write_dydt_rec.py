...
def write_dydt_rec(): # define function
	...
	# suggest 1 Tab
	f.write('def dydt_rec(y, rindx, rstoi, reac_coef, pindx, pstoi, nprod, step, dydt_vst, nreac, num_sb, num_speci, pconc, core_diss, Psat, kelv_fac, kimt, kwgt, Cw, act_coeff):\n')
	f.write('	\n')
	...
	f.write('			stoi_indx = (np.where(pindx[i, 0:nreac[i]]==compi))[0]\n')
	f.write('			if len(stoi_indx)>0: \n')
