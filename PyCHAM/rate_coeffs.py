...
# created at 2020-10-13 10:02:12.427963
...
def evaluate_rates(RO2, H2O, TEMP, lightm, time, lat, lon, act_flux_path, DayOfYear, M, N2, O2, photo_par_file, Jlen, tf):
	...
	rate_values[49] = 2.80e-15*numpy.exp(-770/TEMP)*0.720
	rate_values[50] = 2.80e-15*numpy.exp(-770/TEMP)*0.010
	rate_values[51] = 2.80e-15*numpy.exp(-770/TEMP)*0.270
	rate_values[52] = 4.28e-11*numpy.exp(401/TEMP)*0.408
	rate_values[53] = 4.28e-11*numpy.exp(401/TEMP)*0.222
	rate_values[54] = 4.28e-11*numpy.exp(401/TEMP)*0.370
	rate_values[55] = KRO2HO2*0.914
	rate_values[56] = KRO2NO
	rate_values[57] = KRO2NO3
	rate_values[58] = 9.20e-14*RO2*0.3
	rate_values[59] = 9.20e-14*RO2*0.7
	rate_values[60] = KDEC*0.5
	rate_values[61] = KDEC*0.5
	rate_values[62] = KDEC*0.5
	rate_values[63] = KDEC*0.5
	rate_values[64] = KRO2HO2*0.914
	rate_values[65] = KRO2NO*0.228
	rate_values[66] = KRO2NO*0.772
	rate_values[67] = KRO2NO3
	rate_values[68] = 9.20e-14*RO2*0.7
	rate_values[69] = 9.20e-14*RO2*0.3
	rate_values[70] = KRO2HO2*0.914
	rate_values[71] = KRO2NO*0.228
	rate_values[72] = KRO2NO*0.772
	rate_values[73] = KRO2NO3
	rate_values[74] = 8.80e-13*RO2*0.2
	rate_values[75] = 8.80e-13*RO2*0.2
	rate_values[76] = 8.80e-13*RO2*0.6
	rate_values[77] = KRO2HO2*0.914
	rate_values[78] = KRO2NO*0.228
	rate_values[79] = KRO2NO*0.772
	rate_values[80] = KRO2NO3
	rate_values[81] = 9.20e-14*RO2*0.7
	rate_values[82] = 9.20e-14*RO2*0.3
