...
class PyCHAM(QWidget):
	...
	def on_click1(self):
		...
		#sch_name = str(os.getcwd() + '/PyCHAM/output/GMD_paper_plotting_scripts/isoprene_scheme_MCM.txt')
	...
	def on_click3(self):
		...
		#inname = str(os.getcwd() + '/PyCHAM/output/GMD_paper_plotting_scripts/Gaswall_sens_inputs.txt')
