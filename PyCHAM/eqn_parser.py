# Originated from Dave Topping; modified by Shuxuan Xu
# This script is responsible for parsing .eqn files.  See the README for how to format the
# equation file.
...
# main part by Dave (/s)
def write_rate_file(filename, reac_coef, mcm_constants, MCMConstNameList):
    
    f = open('Rate_coefficients.py', mode='w')
