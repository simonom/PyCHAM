...
def def_mod_var(caller, self): # define function
	...
	photopath = str(photopath[0:-12] + '/PyCHAM')
	...
	self.wall_on = 0 # marker for whether to consider wall (0 for no, 1 for yes)
	...
	# flag for deposition to wall treatment (0 for customised, 1 for 
	# Rader and McMurry (1985))
	Rader = -1 
